...
C:/ti/tirtos_c2000_2_16_01_14/products/bios_6_45_02_31/packages/ti/targets/ITarget.xs:
package.mak: C:/ti/tirtos_c2000_2_16_01_14/products/bios_6_45_02_31/packages/ti/targets/ITarget.xs
C:/ti/tirtos_c2000_2_16_01_14/products/bios_6_45_02_31/packages/ti/targets/C28_large.xs:
package.mak: C:/ti/tirtos_c2000_2_16_01_14/products/bios_6_45_02_31/packages/ti/targets/C28_large.xs
C:/ti/tirtos_c2000_2_16_01_14/products/bios_6_45_02_31/packages/ti/targets/C28_float.xs:
package.mak: C:/ti/tirtos_c2000_2_16_01_14/products/bios_6_45_02_31/packages/ti/targets/C28_float.xs
C:/ti/tirtos_c2000_2_16_01_14/products/bios_6_45_02_31/packages/ti/targets/package.xs:
package.mak: C:/ti/tirtos_c2000_2_16_01_14/products/bios_6_45_02_31/packages/ti/targets/package.xs
...
ti.targets.C28_float.rootDir ?= C:/ti/ccsv8/tools/compiler/ti-cgt-c2000_18.1.1.LTS
ti.targets.packageBase ?= C:/ti/tirtos_c2000_2_16_01_14/products/bios_6_45_02_31/packages/ti/targets/
...
package/%.xdc.inc package/%_xconfig_Lab1.c package/%.defs.h: %.xdc $(PKGCFGS)
	@$(MSG) generating interfaces for package xconfig_Lab1" (because $@ is older than $(firstword $?))" ...
	$(XSRUN) -f xdc/services/intern/cmd/build.xs $(MK_IDLOPTS) -m package/package.xdc.dep -i package/package.xdc.inc package.xdc

.dlls,28FP .dlls: Lab1.p28FP

-include package/cfg/Lab1_p28FP.mak
-include package/cfg/Lab1_p28FP.cfg.mak
ifeq (,$(MK_NOGENDEPS))
-include package/cfg/Lab1_p28FP.dep
endif
Lab1.p28FP: package/cfg/Lab1_p28FP.xdl
	@


ifeq (,$(wildcard .libraries,28FP))
Lab1.p28FP package/cfg/Lab1_p28FP.c: .libraries,28FP
endif

package/cfg/Lab1_p28FP.c package/cfg/Lab1_p28FP.h package/cfg/Lab1_p28FP.xdl: override _PROG_NAME := Lab1.x28FP
package/cfg/Lab1_p28FP.c: package/cfg/Lab1_p28FP.cfg
package/cfg/Lab1_p28FP.xdc.inc: package/cfg/Lab1_p28FP.xdl
package/cfg/Lab1_p28FP.xdl package/cfg/Lab1_p28FP.c: .interfaces

clean:: clean,28FP
	-$(RM) package/cfg/Lab1_p28FP.cfg
	-$(RM) package/cfg/Lab1_p28FP.dep
	-$(RM) package/cfg/Lab1_p28FP.c
	-$(RM) package/cfg/Lab1_p28FP.xdc.inc

clean,28FP::
	-$(RM) Lab1.p28FP
.executables,28FP .executables: Lab1.x28FP

Lab1.x28FP: |Lab1.p28FP

-include package/cfg/Lab1.x28FP.mak
Lab1.x28FP: package/cfg/Lab1_p28FP.o28FP 
	$(RM) $@
	@$(MSG) lnk28FP $@ ...
	$(RM) $(XDCCFGDIR)/$@.map
	$(ti.targets.C28_float.rootDir)/bin/cl2000 -q -u _c_int00 -z  -o $@ package/cfg/Lab1_p28FP.o28FP   package/cfg/Lab1_p28FP.xdl  -w -c -m $(XDCCFGDIR)/$@.map -l $(ti.targets.C28_float.rootDir)/lib/libc.a
	
Lab1.x28FP: export C_DIR=
Lab1.x28FP: PATH:=$(ti.targets.C28_float.rootDir)/bin/;$(PATH)
Lab1.x28FP: Path:=$(ti.targets.C28_float.rootDir)/bin/;$(PATH)

Lab1.test test,28FP test: Lab1.x28FP.test

Lab1.x28FP.test:: Lab1.x28FP
ifeq (,$(_TESTLEVEL))
	@$(MAKE) -R -r --no-print-directory -f $(XDCROOT)/packages/xdc/bld/xdc.mak _TESTLEVEL=1 Lab1.x28FP.test
else
	@$(MSG) running $<  ...
	$(call EXEC.Lab1.x28FP, ) 
endif

clean,28FP::
	-$(RM) $(wildcard .tmp,Lab1.x28FP,*)
...
%,copy:
	...
	$(RM) $@
	$(CP) $< $@
Lab1_p28FP.o28FP,copy : package/cfg/Lab1_p28FP.o28FP
Lab1_p28FP.s28FP,copy : package/cfg/Lab1_p28FP.s28FP

$(XDCCFGDIR)%.c $(XDCCFGDIR)%.h $(XDCCFGDIR)%.xdl: $(XDCCFGDIR)%.cfg $(XDCROOT)/packages/xdc/cfg/Main.xs | .interfaces
	@$(MSG) "configuring $(_PROG_NAME) from $< ..."
	$(CONFIG) $(_PROG_XSOPTS) xdc.cfg $(_PROG_NAME) $(XDCCFGDIR)$*.cfg $(XDCCFGDIR)$*

.PHONY: release,xconfig_Lab1
ifeq (,$(MK_NOGENDEPS))
-include package/rel/xconfig_Lab1.tar.dep
endif
package/rel/xconfig_Lab1/xconfig_Lab1/package/package.rel.xml: package/package.bld.xml
package/rel/xconfig_Lab1/xconfig_Lab1/package/package.rel.xml: package/build.cfg
package/rel/xconfig_Lab1/xconfig_Lab1/package/package.rel.xml: package/package.xdc.inc
package/rel/xconfig_Lab1/xconfig_Lab1/package/package.rel.xml: .force
	@$(MSG) generating external release references $@ ...
	$(XS) $(JSENV) -f $(XDCROOT)/packages/xdc/bld/rel.js $(MK_RELOPTS) . $@

xconfig_Lab1.tar: package/rel/xconfig_Lab1.xdc.inc package/rel/xconfig_Lab1/xconfig_Lab1/package/package.rel.xml
	@$(MSG) making release file $@ "(because of $(firstword $?))" ...
	-$(RM) $@
	$(call MKRELTAR,package/rel/xconfig_Lab1.xdc.inc,package/rel/xconfig_Lab1.tar.dep)


release release,xconfig_Lab1: all xconfig_Lab1.tar
clean:: .clean
	-$(RM) xconfig_Lab1.tar
	-$(RM) package/rel/xconfig_Lab1.xdc.inc
	-$(RM) package/rel/xconfig_Lab1.tar.dep
