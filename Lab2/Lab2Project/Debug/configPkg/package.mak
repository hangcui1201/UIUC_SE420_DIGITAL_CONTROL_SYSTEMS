...
.dlls,28FP .dlls: Lab2.p28FP

-include package/cfg/Lab2_p28FP.mak
-include package/cfg/Lab2_p28FP.cfg.mak
ifeq (,$(MK_NOGENDEPS))
-include package/cfg/Lab2_p28FP.dep
endif
Lab2.p28FP: package/cfg/Lab2_p28FP.xdl
	@


ifeq (,$(wildcard .libraries,28FP))
Lab2.p28FP package/cfg/Lab2_p28FP.c: .libraries,28FP
endif

package/cfg/Lab2_p28FP.c package/cfg/Lab2_p28FP.h package/cfg/Lab2_p28FP.xdl: override _PROG_NAME := Lab2.x28FP
package/cfg/Lab2_p28FP.c: package/cfg/Lab2_p28FP.cfg
package/cfg/Lab2_p28FP.xdc.inc: package/cfg/Lab2_p28FP.xdl
package/cfg/Lab2_p28FP.xdl package/cfg/Lab2_p28FP.c: .interfaces

clean:: clean,28FP
	-$(RM) package/cfg/Lab2_p28FP.cfg
	-$(RM) package/cfg/Lab2_p28FP.dep
	-$(RM) package/cfg/Lab2_p28FP.c
	-$(RM) package/cfg/Lab2_p28FP.xdc.inc

clean,28FP::
	-$(RM) Lab2.p28FP
.executables,28FP .executables: Lab2.x28FP

Lab2.x28FP: |Lab2.p28FP

-include package/cfg/Lab2.x28FP.mak
Lab2.x28FP: package/cfg/Lab2_p28FP.o28FP 
	$(RM) $@
	@$(MSG) lnk28FP $@ ...
	$(RM) $(XDCCFGDIR)/$@.map
	$(ti.targets.C28_float.rootDir)/bin/cl2000 -q -u _c_int00 -z  -o $@ package/cfg/Lab2_p28FP.o28FP   package/cfg/Lab2_p28FP.xdl  -w -c -m $(XDCCFGDIR)/$@.map -l $(ti.targets.C28_float.rootDir)/lib/libc.a
	
Lab2.x28FP: export C_DIR=
Lab2.x28FP: PATH:=$(ti.targets.C28_float.rootDir)/bin/;$(PATH)
Lab2.x28FP: Path:=$(ti.targets.C28_float.rootDir)/bin/;$(PATH)

Lab2.test test,28FP test: Lab2.x28FP.test

Lab2.x28FP.test:: Lab2.x28FP
ifeq (,$(_TESTLEVEL))
	@$(MAKE) -R -r --no-print-directory -f $(XDCROOT)/packages/xdc/bld/xdc.mak _TESTLEVEL=1 Lab2.x28FP.test
else
	@$(MSG) running $<  ...
	$(call EXEC.Lab2.x28FP, ) 
endif

clean,28FP::
	-$(RM) $(wildcard .tmp,Lab2.x28FP,*)
...
%,copy:
	...
	$(RM) $@
	$(CP) $< $@
Lab2_p28FP.o28FP,copy : package/cfg/Lab2_p28FP.o28FP
Lab2_p28FP.s28FP,copy : package/cfg/Lab2_p28FP.s28FP
